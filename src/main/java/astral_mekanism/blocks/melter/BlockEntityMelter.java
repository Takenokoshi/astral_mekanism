...
public class BlockEntityMelter extends TileEntityProgressMachine<ItemStackToFluidRecipe>
	...
	BasicFluidTank outputFluidTank;
	...
	public BlockEntityMelter(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
	...
	protected IInventorySlotHolder getInitialInventory(IContentsListener listener,
		...
		builder.addSlot(this.fluidSlot = FluidInventorySlot.drain(this.outputFluidTank, listener, 34, 17));
