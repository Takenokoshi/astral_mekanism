package astral_mekanism.blocks.melter;
...
public class GuiMelter
		extends GuiConfigurableTile<BlockEntityMelter, MekanismTileContainer<BlockEntityMelter>> {

	public GuiMelter(MekanismTileContainer<BlockEntityMelter> container, Inventory inv, Component title) {
	...
	protected void addGuiElements() {
		...
		addRenderableWidget(new GuiFluidGauge(() -> tile.outputFluidTank, () -> List.of(tile.outputFluidTank),
				...
				.warning(WarningType.NO_SPACE_IN_OUTPUT, tile.getWarningCheck(
						BlockEntityMelter.NOT_ENOUGH_SPACE_FLUID_OUTPUT_ERROR));
		...
		addRenderableWidget(new GuiProgress(tile::getScaledProgress, ProgressType.RIGHT, this, 77, 38))
				.jeiCategories(MekJEIRecipeTypes.Melter_recipe)
