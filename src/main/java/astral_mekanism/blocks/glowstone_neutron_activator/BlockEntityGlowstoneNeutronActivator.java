...
public class BlockEntityGlowstoneNeutronActivator extends TileEntityRecipeMachine<GasToGasRecipe>
	...
	public BlockEntityGlowstoneNeutronActivator(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
	...
	private boolean canFunction() {
		// Sort out if the solar neutron activator can see the sun; we no longer check
		// if it's raining here,
		// since under the new rules, we can still function when it's raining, albeit at
