...
public class GuiGreenHouse
		extends GuiConfigurableTile<BlockEntityGreenHouse, MekanismTileContainer<BlockEntityGreenHouse>> {

	public GuiGreenHouse(MekanismTileContainer<BlockEntityGreenHouse> container, Inventory inv, Component title) {
	...
	protected void addGuiElements() {
		...
		addRenderableWidget(new GuiFluidGauge(() -> tile.inputFluidTank, () -> List.of(tile.inputFluidTank),
				...
				.warning(WarningType.NO_MATCHING_RECIPE,
						tile.getWarningCheck(
								BlockEntityGreenHouse.NOT_ENOUGH_FLUID_INPUT_ERROR)));
		...
		addRenderableWidget(new GuiProgress(tile::getScaledProgress, ProgressType.RIGHT, this, 77, 38))
				.jeiCategories(MekJEIRecipeTypes.Greenhouse_recipe)
