package astral_mekanism.blocks.green_house;
...
public class BlockEntityGreenHouse extends TileEntityProgressMachine<GreenHouseRecipe>
	...
	MachineEnergyContainer<BlockEntityGreenHouse> energyContainer;
	...
	public BlockEntityGreenHouse(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
	...
	public MachineEnergyContainer<BlockEntityGreenHouse> getEnergyContainer() {
	...
	public @NotNull CachedRecipe<GreenHouseRecipe> createNewCachedRecipe(@NotNull GreenHouseRecipe recipe,
		...
		MachineEnergyContainer<BlockEntityGreenHouse> energyContainer = this.energyContainer;
