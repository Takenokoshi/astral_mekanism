...
public class GuiCompactTEP
		extends GuiConfigurableTile<BlockEntityCompactTEP, MekanismTileContainer<BlockEntityCompactTEP>> {

	public GuiCompactTEP(MekanismTileContainer<BlockEntityCompactTEP> container, Inventory inv,
			Component title) {
