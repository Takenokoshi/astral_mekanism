...
public enum AMELang implements ILangEntry {
    ...
    DESCRIPTION_ENCHANTED_MACHINE("description", "enchanted_machine"),
    DESCRIPTION_AM_GENERATOR("description", "am_generator"),
    DESCRIPTION_ESSENTIAL_CRAFTER("description", "essential_crafter"),
    DESCRIPTION_ESSENTIAL_REACTION_CHAMBER("description", "essential_reaction_chamber"),
    ...
    DESCRIPTION_GAS_SYNTHESIZER("description", "gas_synthesizer"),
    DESCRIPTION_INFUSE_SYNTHESIZER("description", "infuse_synthesizer"),
    DESCRIPTION_INFUSING_CONDENSENTRATOR("description", "infusing_condensentrator"),
    DESCRIPTION_IAMRA("description", "interstellar_antineutronic_matter_reconstruction_apparatus"),
    ...
    DESCRIPTION_MEKANICAL_COMPOSTER("description", "mekanical_composter"),
    DESCRIPTION_MEKANICAL_INSCRIBER("description", "mekanical_inscriber"),
    DESCRIPTION_MEKANICAL_MATTER_CONDENSER("description", "mekanical_matter_condenser"),
    ...
    DESCRIPTION_MEKANICAL_MAGMABLOCK("description", "mekanical_magma_blocks"),
    ...
    DESCRIPTION_EVENLY_INSERTER("description", "evenly_inserter"),
    DESCRIPTION_RATIO_SEPARATOR("description", "ratio_separator"),
    DESCRIPTION_XP_TANK("description", "xp_tank"),
    ...
    DESCRIPTION_SORTABLE_STORAGE_FILTER_CARD("description", "sortable_storage_filter_card"),
