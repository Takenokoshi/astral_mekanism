...
public interface MekanismRecipeTypeMixin {
    @Invoker("<init>")
    static <MR extends MekanismRecipe, IIRC extends IInputRecipeCache> MekanismRecipeType<MR, IIRC> invokeNew(String name, Function<MekanismRecipeType<MR, IIRC>, IIRC> inputCacheCreator) {
        return null;
    }
