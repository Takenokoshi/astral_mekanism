...
public interface MekanismRecipeTypeMixin<RECIPE extends MekanismRecipe, INPUT_CACHE extends IInputRecipeCache> {
    @Invoker("<init>")
    public static <RECIPE extends MekanismRecipe, INPUT_CACHE extends IInputRecipeCache> MekanismRecipeType<RECIPE, INPUT_CACHE> astral_mekanism$invokeNew(
    ...
    public abstract void astral_mekanism$setRegistryName(ResourceLocation resourceLocation);

    @Mutable
    @Accessor("inputCache")
    public abstract void astral_mekanism$setInputCache(INPUT_CACHE inputCache);
}
