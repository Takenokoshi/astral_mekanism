...
public class MekanicalTransformOldCachedRecipe extends CachedRecipe<MekanicalTransformOldRecipe> {
    ...
    public MekanicalTransformOldCachedRecipe(MekanicalTransformOldRecipe recipe,
