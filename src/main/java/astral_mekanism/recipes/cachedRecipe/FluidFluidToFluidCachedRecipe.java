    ...
    protected void calculateOperationsThisTick(OperationTracker tracker) {
        ...
        if (tracker.shouldContinueChecking()) {
            ...
            if (inputFluidA.isEmpty() || inputFluidB.isEmpty()) {
                ...
                Supplier<FluidStackIngredient> leftIngredient;
                Supplier<FluidStackIngredient> rightIngredient;
                if (!inputA.test(inputFluidA) || !inputB.test(inputFluidB)) {
                    leftIngredient = () -> inputB;
                    rightIngredient = () -> inputA;
                } else {
                    leftIngredient = () -> inputA;
                    rightIngredient = () -> inputB;
                }
                CachedRecipeHelper.twoInputCalculateOperationsThisTick(tracker,
                        inputHandlerA, leftIngredient, inputHandlerB, rightIngredient, (A, B) -> {
                            recipeInputA = A;
                            recipeInputB = B;
