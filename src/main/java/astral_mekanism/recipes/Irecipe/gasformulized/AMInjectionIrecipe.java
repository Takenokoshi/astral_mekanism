...
public class AMInjectionIrecipe extends ItemStackGasToItemStackRecipe {

    private final int gasUp;

    public AMInjectionIrecipe(ResourceLocation id, ItemStackIngredient itemInput, GasStackIngredient gasInput,
    ...
    public static IFactory<Gas, GasStack, GasStackIngredient, ItemStackGasToItemStackRecipe> getFac(int num) {
        return (a, b, c, d) -> new AMInjectionIrecipe(a, b, c, d, num);
    }

    @Override
    public RecipeSerializer<?> getSerializer() {
        return AstralMekanismRecipeSerializers.AM_INJECTING[gasUp].get();
    }

    @Override
    public RecipeType<?> getType() {
        return AstralMekanismRecipeTypes.AM_INJECTING[gasUp].get();
    }
