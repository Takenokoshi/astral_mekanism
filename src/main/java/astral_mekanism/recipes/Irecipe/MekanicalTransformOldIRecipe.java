...
public class MekanicalTransformOldIRecipe extends MekanicalTransformOldRecipe {

    public MekanicalTransformOldIRecipe(ResourceLocation id, ItemStackIngredient inputItemA, ItemStackIngredient inputItemB,
    ...
    public RecipeSerializer<?> getSerializer() {
        return AstralMekanismRecipeSerializers.MEKANICAL_TRANSFORM_OLD.get();
    }

    @Override
    public RecipeType<?> getType() {
        return AstralMekanismRecipeTypes.MEKANICAL_TRANSFORM_OLD.get();
    }
