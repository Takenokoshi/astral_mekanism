...
public class AstralMekanismGases {
    ...
    static final GasRegistryObject<Gas> NETHERRACK = GASES.register("netherrack", () -> {
        return new Gas(GasBuilder.builder(new ResourceLocation("block/netherrack")));
    });
    static final GasRegistryObject<Gas> NETHERITE_ETHER = GASES.register("netherite_ether", 0x4A3A33);
}
