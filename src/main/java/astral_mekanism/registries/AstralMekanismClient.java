...
public class AstralMekanismClient {
	...
	public static void registerContiners(RegisterEvent event) {
		event.register(Registries.MENU, helper -> {
			...
			ClientRegistrationUtil.registerScreen(AstralMekanismContainers.ASTRAL_ENRICHMENT_CHAMBER,
					GuiAstralElectricMachine<BEAstralEnrichmentChamber>::new);
			ClientRegistrationUtil.registerScreen(AstralMekanismContainers.ASTRAL_MEKANICAL_CHARGER,
