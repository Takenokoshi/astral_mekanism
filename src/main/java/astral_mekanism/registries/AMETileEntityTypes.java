...
public class AMETileEntityTypes {
    private AMETileEntityTypes() {
    }
    ...
    public static final TileEntityTypeRegistryObject<TileEntityUniversalCable> ASTRAL_UNIVERSAL_CABLE = TILE_ENTITY_TYPES
            .builder(AMEBlocks.ASTRAL_UNIVERSAL_CABLE,
                    (p, s) -> new TileEntityUniversalCable(AMEBlocks.ASTRAL_UNIVERSAL_CABLE, p, s))
