...
public class MekanicalTransformOldRecipeCategory extends BaseRecipeCategory<MekanicalTransformOldRecipe> {
    ...
    public MekanicalTransformOldRecipeCategory(IGuiHelper helper,
