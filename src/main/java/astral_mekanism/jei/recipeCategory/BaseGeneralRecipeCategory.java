...
public abstract class BaseGeneralRecipeCategory<RECIPE extends Recipe<?>> implements IRecipeCategory<RECIPE>,IGuiWrapper {
    ...
    protected BaseGeneralRecipeCategory(IGuiHelper helper, RecipeType<RECIPE> recipeType, IItemProvider provider, int xOffset, int yOffset, int width, int height) {
        this(helper, recipeType, provider.getTextComponent(), createIcon(helper, provider), xOffset, yOffset, width, height);
    }

    protected BaseGeneralRecipeCategory(IGuiHelper helper, RecipeType<RECIPE> recipeType, Component component, IDrawable icon, int xOffset, int yOffset, int width, int height) {
