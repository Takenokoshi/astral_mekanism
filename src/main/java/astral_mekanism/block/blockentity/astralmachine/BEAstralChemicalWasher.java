...
public class BEAstralChemicalWasher extends TileEntityRecipeMachine<FluidSlurryToSlurryRecipe> implements
    ...
    private MachineEnergyContainer<BEAstralChemicalWasher> energyContainer;
    ...
    public BEAstralChemicalWasher(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        ...
        configComponent = new TileComponentConfig(this, TransmissionType.ITEM, TransmissionType.SLURRY,
    ...
    @NotNull
    @Override
    public CachedRecipe<FluidSlurryToSlurryRecipe> createNewCachedRecipe(@NotNull FluidSlurryToSlurryRecipe recipe,
            int cacheIndex) {
    ...
    public MachineEnergyContainer<BEAstralChemicalWasher> getEnergyContainer() {
