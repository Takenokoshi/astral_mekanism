...
public class BEAstralChemixer extends TileEntityRecipeMachine<ChemixerRecipe> implements
    ...
    private MachineEnergyContainer<BEAstralChemixer> energyContainer;
    ...
    public MachineEnergyContainer<BEAstralChemixer> getEnergyContainer() {
