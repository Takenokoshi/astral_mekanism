...
public class BEAstralMelter extends TileEntityRecipeMachine<ItemStackToFluidRecipe>
    ...
    public BEAstralMelter(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    private int getBaselineMaxOperations() {
        long v = Math.round(heatCapacitor.getTemperature() - 273) / 1000;
