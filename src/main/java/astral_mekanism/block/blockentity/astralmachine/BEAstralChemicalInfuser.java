...
public class BEAstralChemicalInfuser extends TileEntityRecipeMachine<ChemicalInfuserRecipe>
    ...
    private MachineEnergyContainer<BEAstralChemicalInfuser> energyContainer;
    ...
    public BEAstralChemicalInfuser(BlockPos pos, BlockState state) {
