...
public class BEAstralRadiationIrradiator extends MSTileEntityRecipeMachine<RadiationIrradiatingRecipe> implements
    ...
    private MachineEnergyContainer<BEAstralRadiationIrradiator> energyContainer;
    ...
    public IChemicalTankHolder<Gas, GasStack, IGasTank> getInitialGasTanks(IContentsListener listener,
        ...
        builder.addTank(injectTank = ChemicalTankBuilder.GAS.create(MAX_CHEMICAL,
    ...
    public MachineEnergyContainer<BEAstralRadiationIrradiator> getEnergyContainer() {
