...
public class BEAstralElectrolyticSeparator extends TileEntityRecipeMachine<ElectrolysisRecipe>
    ...
    private static final BiFunction<FloatingLong, BEAstralElectrolyticSeparator, FloatingLong> BASE_ENERGY_CALCULATOR = (
    ...
    private static final int baselineMaxOperations = Integer.MAX_VALUE;
    ...
    private FixedUsageEnergyContainer<BEAstralElectrolyticSeparator> energyContainer;
    ...
    public FixedUsageEnergyContainer<BEAstralElectrolyticSeparator> getEnergyContainer() {
