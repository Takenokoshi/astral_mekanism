...
public class BEAstralRotaryCondensentrator extends TileEntityRecipeMachine<RotaryRecipe> implements IHasMode {
    ...
    private MachineEnergyContainer<BEAstralRotaryCondensentrator> energyContainer;
    ...
    public MachineEnergyContainer<BEAstralRotaryCondensentrator> getEnergyContainer() {
