...
public class BEOldAstralGreenhouse extends TileEntityRecipeMachine<GreenhouseRecipe>
        implements IOldGreenhouse<BEOldAstralGreenhouse> {
    ...
    private MachineEnergyContainer<BEOldAstralGreenhouse> energyContainer;
    ...
    public BEOldAstralGreenhouse(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<BEOldAstralGreenhouse> getEnergyContainer() {
