...
public class BEOldAstralMekanicalInscriber extends BEDoubleItemToItemRecipeMachine {

    public BEOldAstralMekanicalInscriber(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
