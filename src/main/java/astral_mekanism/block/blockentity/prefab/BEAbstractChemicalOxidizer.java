...
public abstract class BEAbstractChemicalOxidizer extends TileEntityRecipeMachine<ItemStackToGasRecipe>
    ...
    private MachineEnergyContainer<BEAbstractChemicalOxidizer> energyContainer;
    private InputInventorySlot inputSlot;
    private GasInventorySlot outputSlot;
    private EnergyInventorySlot energySlot;

    public BEAbstractChemicalOxidizer(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public MachineEnergyContainer<BEAbstractChemicalOxidizer> getEnergyContainer() {
