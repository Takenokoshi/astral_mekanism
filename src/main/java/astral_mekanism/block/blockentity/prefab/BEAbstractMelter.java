...
public abstract class BEAbstractMelter extends TileEntityRecipeMachine<ItemStackToFluidRecipe>
    ...
    public BEAbstractMelter(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
