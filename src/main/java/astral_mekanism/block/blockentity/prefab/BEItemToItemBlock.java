...
public abstract class BEItemToItemBlock extends TileEntityRecipeMachine<ItemStackToItemStackRecipe>
    ...
    protected BEItemToItemBlock(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
