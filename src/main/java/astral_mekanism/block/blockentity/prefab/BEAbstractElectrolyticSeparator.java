...
public abstract class BEAbstractElectrolyticSeparator extends TileEntityRecipeMachine<ElectrolysisRecipe>
    ...
    private static final BiFunction<FloatingLong, BEAbstractElectrolyticSeparator, FloatingLong> BASE_ENERGY_CALCULATOR = (
    ...
    private FixedUsageEnergyContainer<BEAbstractElectrolyticSeparator> energyContainer;
    ...
    public BEAbstractElectrolyticSeparator(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public FixedUsageEnergyContainer<BEAbstractElectrolyticSeparator> getEnergyContainer() {
