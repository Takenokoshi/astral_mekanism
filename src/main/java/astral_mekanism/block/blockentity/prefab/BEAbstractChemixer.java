...
public abstract class BEAbstractChemixer extends TileEntityRecipeMachine<ChemixerRecipe> implements
    ...
    private MachineEnergyContainer<BEAbstractChemixer> energyContainer;

    public BEAbstractChemixer(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public MachineEnergyContainer<BEAbstractChemixer> getEnergyContainer() {
