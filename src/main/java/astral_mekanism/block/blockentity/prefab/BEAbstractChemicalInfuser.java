...
public abstract class BEAbstractChemicalInfuser extends TileEntityRecipeMachine<ChemicalInfuserRecipe>
        implements EitherSideChemicalRecipeLookupHandler<Gas, GasStack, ChemicalInfuserRecipe> {
    ...
    private MachineEnergyContainer<BEAbstractChemicalInfuser> energyContainer;
    ...
    protected BEAbstractChemicalInfuser(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @NotNull
    @Override
    public CachedRecipe<ChemicalInfuserRecipe> createNewCachedRecipe(@NotNull ChemicalInfuserRecipe recipe,
            int cacheIndex) {
    ...
    public MachineEnergyContainer<BEAbstractChemicalInfuser> getEnergyContainer() {
