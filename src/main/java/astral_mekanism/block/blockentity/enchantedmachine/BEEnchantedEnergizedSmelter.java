...
public class BEEnchantedEnergizedSmelter extends BETickWorkEnergizedSmelter<BEEnchantedEnergizedSmelter> {
    private int baselineMaxOperations = 200;

    public BEEnchantedEnergizedSmelter(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
