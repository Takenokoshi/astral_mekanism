...
import astral_mekanism.block.blockentity.basemachine.BETickWorkMekanicalInscriber;
...
public class BEEnchantedMekanicalInscriber extends BETickWorkMekanicalInscriber {
    private int baselineMaxOperations = 2;

    public BEEnchantedMekanicalInscriber(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
