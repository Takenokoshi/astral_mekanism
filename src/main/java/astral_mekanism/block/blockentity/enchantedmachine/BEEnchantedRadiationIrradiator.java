...
public class BEEnchantedRadiationIrradiator extends BEAMERadiationIrradiator {
    private int baselineMaxOperations = 1;
    private long inputTankCapacity = 1 * 5000;

    public BEEnchantedRadiationIrradiator(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
