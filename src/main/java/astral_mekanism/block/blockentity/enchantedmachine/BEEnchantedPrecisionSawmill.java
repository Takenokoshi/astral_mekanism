...
public class BEEnchantedPrecisionSawmill extends BEAMEPrecisionSawmill {

    private int baselineMaxOperations = 1;

    public BEEnchantedPrecisionSawmill(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
