...
public class BEEnchantedEnrichmentChamber extends BEAMEElectricMachine {
    private int baselineMaxOperations = 200;

    public BEEnchantedEnrichmentChamber(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
