...
public class BEEnchantedGreenHouse extends BETickWorkGreenHouse {

    int baselineMaxOperations = 1;
    private int inputTankCapacity = 1 * 5000;

    public BEEnchantedGreenHouse(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
