...
public class BECompactAPT extends TileEntityProgressMachine<ItemStackGasToItemStackRecipe>
    ...
    private static final List<RecipeError> TRACKED_ERROR_TYPES = List.of(RecipeError.NOT_ENOUGH_ENERGY,
    ...
    public void addContainerTrackers(MekanismContainer container) {
        ...
        container.track(SyncableFloatingLong.create(this::getEnergyUsage, v -> lastEnergyUsed = v));
    }
