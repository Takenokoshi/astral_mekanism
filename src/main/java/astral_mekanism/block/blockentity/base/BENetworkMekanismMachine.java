...
public class BENetworkMekanismMachine extends TileEntityMekanism implements IGridConnectedBlockEntity {

    protected final IManagedGridNode mainNode;
    private boolean setChangedQueued = false;

    public BENetworkMekanismMachine(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    protected void scheduleInit() {
        GridHelper.onFirstTick(this, BENetworkMekanismMachine::onReady);
    }
