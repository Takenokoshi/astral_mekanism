...
public class BEItemCompressor extends TileEntityElectricMachine {

    public BEItemCompressor(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public @NotNull IMekanismRecipeTypeProvider<ItemStackToItemStackRecipe, SingleItem<ItemStackToItemStackRecipe>> getRecipeType() {
        return AstralMekanismRecipeTypes.ITEM_COMPRESSING;
    }
