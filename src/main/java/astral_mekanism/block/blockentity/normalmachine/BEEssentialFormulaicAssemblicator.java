...
public class BEEssentialFormulaicAssemblicator extends TileEntityConfigurableMachine
        implements IAMEFormulaicAssemblicator, IHasCustomSizeContainer {
    ...
    private MachineEnergyContainer<BEEssentialFormulaicAssemblicator> energyContainer
    ...
    public MachineEnergyContainer<BEEssentialFormulaicAssemblicator> getEnergyContainer() {
