...
public class BEOldGreenhouse extends TileEntityProgressMachine<GreenhouseRecipe> implements IOldGreenhouse<BEOldGreenhouse> {
    ...
    private MachineEnergyContainer<BEOldGreenhouse> energyContainer;
    ...
    public BEOldGreenhouse(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<BEOldGreenhouse> getEnergyContainer() {
