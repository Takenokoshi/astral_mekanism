...
public abstract class BEAMEChemicalInfuser extends TileEntityRecipeMachine<ChemicalInfuserRecipe>
    ...
    private MachineEnergyContainer<BEAMEChemicalInfuser> energyContainer;
    ...
    protected BEAMEChemicalInfuser(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public MachineEnergyContainer<BEAMEChemicalInfuser> getEnergyContainer() {
