...
public abstract class BEAMERotaryCondensentrator extends TileEntityRecipeMachine<RotaryRecipe> implements IHasMode {
    ...
    private MachineEnergyContainer<BEAMERotaryCondensentrator> energyContainer;
    ...
    public BEAMERotaryCondensentrator(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public MachineEnergyContainer<BEAMERotaryCondensentrator> getEnergyContainer() {
    ...
    public CachedRecipe<RotaryRecipe> createNewCachedRecipe(@NotNull RotaryRecipe recipe, int cacheIndex) {
        return new RotaryCachedRecipe(recipe, recheckAllRecipeErrors, fluidInputHandler, gasInputHandler,
                gasOutputHandler, fluidOutputHandler, () -> mode)
