...
public abstract class BEAMEChemicalWasher extends TileEntityRecipeMachine<FluidSlurryToSlurryRecipe> implements
    ...
    private MachineEnergyContainer<BEAMEChemicalWasher> energyContainer;
