...
public abstract class BEAMEElectrolyticSeparator extends TileEntityRecipeMachine<ElectrolysisRecipe>
        implements IHasGasMode, FluidRecipeLookupHandler<ElectrolysisRecipe>,
        ISustainedData {
    ...
    private static final BiFunction<FloatingLong, BEAMEElectrolyticSeparator, FloatingLong> BASE_ENERGY_CALCULATOR = (
    ...
    private FixedUsageEnergyContainer<BEAMEElectrolyticSeparator> energyContainer;
    ...
    public BEAMEElectrolyticSeparator(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public void onCachedRecipeChanged(@Nullable CachedRecipe<ElectrolysisRecipe> cachedRecipe, int cacheIndex) {
        ...
        recipeEnergyMultiplier = cachedRecipe == null ? FloatingLong.ONE
                : cachedRecipe.getRecipe().getEnergyMultiplier();
    ...
    private boolean canFunction() {
        return MekanismUtils.canFunction(this)
                && (dumpLeft != GasMode.DUMPING_EXCESS || dumpRight != GasMode.DUMPING_EXCESS ||
    ...
    public FixedUsageEnergyContainer<BEAMEElectrolyticSeparator> getEnergyContainer() {
    ...
    public void addContainerTrackers(MekanismContainer container) {
        ...
        container.track(
                SyncableEnum.create(GasMode::byIndexStatic, GasMode.IDLE, () -> dumpLeft, value -> dumpLeft = value));
        container.track(
                SyncableEnum.create(GasMode::byIndexStatic, GasMode.IDLE, () -> dumpRight, value -> dumpRight = value));
