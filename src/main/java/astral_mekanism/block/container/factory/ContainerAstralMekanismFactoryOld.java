...
public class ContainerAstralMekanismFactoryOld<BE extends TileEntityMekanism & IAstralMekanismFactory<BE>>
        extends MekanismTileContainer<BE> {

    public ContainerAstralMekanismFactoryOld(ContainerTypeRegistryObject<?> type, int id, Inventory inv,
            @NotNull BE tile) {
