...
public final class AMBlockShapes {
    ...
    public static final VoxelShape[] ASTRAL_MACHINE_BASIC = VoxelShapeBuilder.create()
            .addShape(0, 0, 0, 2, 16, 2)
            .addShape(14, 0, 0, 16, 16, 2)
            .addShape(0, 0, 14, 2, 16, 16)
            .addShape(14, 0, 14, 16, 16, 16)
            .addShape(0, 0, 0, 16, 2, 2)
            .addShape(0, 14, 0, 16, 16, 2)
            .addShape(0, 0, 14, 16, 2, 16)
            .addShape(0, 14, 14, 16, 16, 16)
            .addShape(0, 0, 0, 2, 2, 16)
            .addShape(14, 0, 0, 16, 2, 16)
            .addShape(0, 14, 0, 2, 16, 16)
            .addShape(14, 14, 0, 16, 16, 16)
            .addShape(2, 2, 2, 14, 14, 14)
            .build4();
