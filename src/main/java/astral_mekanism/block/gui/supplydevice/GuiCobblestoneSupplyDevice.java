...
public class GuiCobblestoneSupplyDevice
        extends GuiConfigurableTile<BECobblestoneSupplyDevice, MekanismTileContainer<BECobblestoneSupplyDevice>> {

    public GuiCobblestoneSupplyDevice(MekanismTileContainer<BECobblestoneSupplyDevice> container, Inventory inv,
            Component title) {
