...
import astral_mekanism.block.blockentity.astralmachine.electric.BEAstralElectricMachine;
...
public class GuiAstralElectricMachine<MACHINE extends BEAstralElectricMachine> extends
        GuiConfigurableTile<MACHINE, MekanismTileContainer<MACHINE>> {
    public GuiAstralElectricMachine(MekanismTileContainer<MACHINE> container,
