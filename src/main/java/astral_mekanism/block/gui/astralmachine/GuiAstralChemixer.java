...
public class GuiAstralChemixer
        extends GuiConfigurableTile<BEAstralChemixer, MekanismTileContainer<BEAstralChemixer>> {

    public GuiAstralChemixer(MekanismTileContainer<BEAstralChemixer> container, Inventory inv, Component title) {
