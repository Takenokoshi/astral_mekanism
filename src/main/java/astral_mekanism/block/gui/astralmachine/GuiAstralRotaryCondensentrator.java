...
public class GuiAstralRotaryCondensentrator extends
        GuiConfigurableTile<BEAstralRotaryCondensentrator, MekanismTileContainer<BEAstralRotaryCondensentrator>> {

    public GuiAstralRotaryCondensentrator(MekanismTileContainer<BEAstralRotaryCondensentrator> container, Inventory inv,
            Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(
                new GuiGasGauge(() -> tile.gasTank, () -> tile.getGasTanks(null), GaugeType.STANDARD, this, 25, 13))
                .warning(WarningType.NO_MATCHING_RECIPE,
        ...
        addRenderableWidget(new GuiProgress(new IBooleanProgressInfoHandler() {
            ...
            public boolean isActive() {
                ...
                .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT,
                        tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
        addRenderableWidget(new ToggleButton(this, 4, 4, () -> tile.mode,
    ...
    protected void drawForegroundText(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        drawString(guiGraphics,
                (tile.mode ? MekanismLang.DECONDENSENTRATING : MekanismLang.CONDENSENTRATING).translate(), 6,
                imageHeight - 92, titleTextColor());
