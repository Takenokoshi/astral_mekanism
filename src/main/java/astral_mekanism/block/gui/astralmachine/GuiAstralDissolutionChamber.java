...
public class GuiAstralDissolutionChamber
        extends GuiConfigurableTile<BEAstralDissolutionChamber, MekanismTileContainer<BEAstralDissolutionChamber>> {

    public GuiAstralDissolutionChamber(MekanismTileContainer<BEAstralDissolutionChamber> container, Inventory inv,
            Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(
                new GuiGasGauge(() -> tile.injectTank, () -> tile.getGasTanks(null), GaugeType.STANDARD, this, 7, 4))
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.LARGE_RIGHT, this, 64, 40)
                .jeiCategories(MekanismJEIRecipeType.DISSOLUTION))
