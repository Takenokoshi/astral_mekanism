...
public class GuiAstralChemicalOxider
        extends GuiConfigurableTile<BEAstralChemicalOxidizer, MekanismTileContainer<BEAstralChemicalOxidizer>> {

    public GuiAstralChemicalOxider(MekanismTileContainer<BEAstralChemicalOxidizer> container, Inventory inv,
            Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(
                new GuiGasGauge(() -> tile.gasTank, () -> tile.getGasTanks(null), GaugeType.STANDARD, this, 131, 13))
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.LARGE_RIGHT, this, 64, 40)
                .jeiCategories(MekanismJEIRecipeType.OXIDIZING))
