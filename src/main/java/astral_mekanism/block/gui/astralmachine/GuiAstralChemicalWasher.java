...
public class GuiAstralChemicalWasher extends GuiConfigurableTile<BEAstralChemicalWasher, MekanismTileContainer<BEAstralChemicalWasher>> {

    public GuiAstralChemicalWasher(MekanismTileContainer<BEAstralChemicalWasher> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.LARGE_RIGHT, this, 64, 39).jeiCategories(MekanismJEIRecipeType.WASHING))
