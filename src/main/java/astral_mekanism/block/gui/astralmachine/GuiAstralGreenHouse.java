...
public class GuiAstralGreenHouse
        extends GuiConfigurableTile<BEAstralGreenHouse, MekanismTileContainer<BEAstralGreenHouse>> {

    public GuiAstralGreenHouse(MekanismTileContainer<BEAstralGreenHouse> container, Inventory inv,
            Component title) {
