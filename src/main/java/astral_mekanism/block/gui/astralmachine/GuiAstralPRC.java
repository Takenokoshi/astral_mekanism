...
public class GuiAstralPRC extends GuiConfigurableTile<BEAstralPRC, MekanismTileContainer<BEAstralPRC>> {

    public GuiAstralPRC(MekanismTileContainer<BEAstralPRC> container, Inventory inv, Component title) {
