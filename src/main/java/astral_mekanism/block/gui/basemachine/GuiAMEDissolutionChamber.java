...
public class GuiAMEDissolutionChamber<BE extends BEAMEDissolutionChamber>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiAMEDissolutionChamber(MekanismTileContainer<BE> container, Inventory inv,
            Component title) {
