...
public class GuiAMEMelter<BE extends BEAMEMelter> extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiVerticalRateBar(this, new GuiBar.IBarInfoHandler() {
            ...
            public Component getTooltip() {
                return MekanismUtils.getTemperatureDisplay(tile.getTemperature(0),
                        UnitDisplayUtils.TemperatureUnit.KELVIN, true);
            }
