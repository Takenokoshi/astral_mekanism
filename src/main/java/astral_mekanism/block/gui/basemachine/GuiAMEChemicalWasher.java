...
public class GuiAMEChemicalWasher<BE extends BEAMEChemicalWasher> extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiAMEChemicalWasher(MekanismTileContainer<BE> container, Inventory inv, Component title) {
