...
public class GuiAMEAdvancedMachine<MACHINE extends BEAMEAdvancedMachine> extends
        GuiConfigurableTile<MACHINE, MekanismTileContainer<MACHINE>> {

    public GuiAMEAdvancedMachine(MekanismTileContainer<MACHINE> container, Inventory inv, Component title) {
