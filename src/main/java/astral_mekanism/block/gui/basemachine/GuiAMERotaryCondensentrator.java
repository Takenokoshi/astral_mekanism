...
public class GuiAMERotaryCondensentrator<BE extends BEAMERotaryCondensentrator> extends
        GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiAMERotaryCondensentrator(MekanismTileContainer<BE> container, Inventory inv,
            Component title) {
