...
public class GuiAMEElectrolyticSeparator<BE extends BEAMEElectrolyticSeparator> extends
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(
                new GuiGasGauge(() -> tile.leftTank, () -> tile.getGasTanks(null), GaugeType.SMALL, this, 58, 18))
        ...
        addRenderableWidget(
                new GuiGasGauge(() -> tile.rightTank, () -> tile.getGasTanks(null), GaugeType.SMALL, this, 100, 18))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.BI, this, 80, 30)
