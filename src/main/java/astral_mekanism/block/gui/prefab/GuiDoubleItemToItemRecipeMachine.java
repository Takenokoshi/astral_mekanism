...
public class GuiDoubleItemToItemRecipeMachine<BE extends BEDoubleItemToItemRecipeMachine>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiDoubleItemToItemRecipeMachine(MekanismTileContainer<BE> container, Inventory inv, Component title) {
