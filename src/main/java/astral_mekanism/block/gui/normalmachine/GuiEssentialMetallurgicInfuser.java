...
public class GuiEssentialMetallurgicInfuser extends
        GuiConfigurableTile<BEEssentialMetallurgicInfuser, MekanismTileContainer<BEEssentialMetallurgicInfuser>> {

    public GuiEssentialMetallurgicInfuser(MekanismTileContainer<BEEssentialMetallurgicInfuser> container, Inventory inv,
            Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(
                new GuiProgress(tile::getScaledProgress, ProgressType.RIGHT, this, 72, 47).jeiCategory(tile))
