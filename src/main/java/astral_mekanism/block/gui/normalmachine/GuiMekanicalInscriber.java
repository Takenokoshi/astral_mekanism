...
public class GuiMekanicalInscriber
        extends GuiConfigurableTile<BEMekanicalInscriber, MekanismTileContainer<BEMekanicalInscriber>> {

    public GuiMekanicalInscriber(MekanismTileContainer<BEMekanicalInscriber> container, Inventory inv,
            Component title) {
